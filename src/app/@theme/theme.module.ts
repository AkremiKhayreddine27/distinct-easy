...
@NgModule({
  imports: [...BASE_MODULES, ...NB_MODULES, NgSelectModule, DistinctTableModule],
  exports: [...BASE_MODULES, ...NB_MODULES, ...COMPONENTS, ...PIPES, LocatusCardHeaderActionsComponent, LocatusFiltersComponent, LocatusCardSearchComponent, LocatusPaginationComponent, LocatusMobileCardHeaderActionsComponent],
  declarations: [...COMPONENTS, ...PIPES, PaymentsComponent, LocatusSelectPropertyComponent, LocatusCardHeaderActionsComponent, LocatusFiltersComponent, LocatusCardSearchComponent, LocatusPaginationComponent, LocatusMobileCardHeaderActionsComponent],
