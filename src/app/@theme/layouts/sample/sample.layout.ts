...
export class SampleLayoutComponent implements OnDestroy {
  ...
  constructor(protected stateService: StateService,
    ...
    this.store.dispatch(new fromStore.GeneratePropertiesData());
  ...
  ngOnInit() {
    ...
    this.selectedProperty$ = this.store.select<any>(fromStore.getSelectedProperty);
    this.store.dispatch(new fromStore.LoadProperties());
    this.store.dispatch(new fromStore.SelectProperty(1));
  }
