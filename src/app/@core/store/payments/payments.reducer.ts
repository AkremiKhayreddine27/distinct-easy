...
import * as fromPaymentsActions from "./payments.action";
...
export function paymentsReducer(
  ...
  action: fromPaymentsActions.PaymentsAction
): PaymentsState {
  switch (action.type) {
...
export const getPaymentsEntities = (state: PaymentsState) => {
  return state.entities;
};
export const getSelectedPayment = (state: PaymentsState) => {
  return state.selectedPayment;
};
export const getPaymentsLoading = (state: PaymentsState) => {
  return state.loading;
};
export const getPaymentsLoaded = (state: PaymentsState) => {
  return state.loaded;
};
export const getPaymentsPagination = (state: PaymentsState) => {
  return state.pagination;
};
export const getPaymentsFilters = (state: PaymentsState) => {
  return state.filters;
};
export const getPaymentsError = (state: PaymentsState) => {
  return state.error;
};
