...
import { Payment, Reservation } from "../../data/models";
...
export const LOAD_SELECTED_PAYMENT_FAIL =
  "[Payments] Load Selected Payment Fail";
export const LOAD_SELECTED_PAYMENT_SUCCESS =
  "[Payments] Load Selected Payment Success";
export const SELECT_PAYMENTS = "[Payments] Select Payments";
export const LOAD_SELECTED_PAYMENTS = "[Payments] Load Selected Payments";
export const LOAD_SELECTED_PAYMENTS_FAIL =
  "[Payments] Load Selected Payments Fail";
export const LOAD_SELECTED_PAYMENTS_SUCCESS =
  "[Payments] Load Selected Payments Success";
...
export class UpdatePayment implements Action {
  ...
  constructor(public id: number, public changes: Partial<Payment>) {}
}
