...
@Component({
  selector: "ngx-potential-nights-front",
  templateUrl: "./potential-nights-front.component.html",
  styleUrls: ["./potential-nights-front.component.scss"]
})
export class PotentialNightsFrontComponent implements AfterViewInit {
  goal: number = 300;
  ...
  ngAfterViewInit() {
    ...
    this.goal = 300;
    this.store
      .select<any>(fromStore.getTotalNbrNights)
      .pipe(
        mergeMap(nbrNights => {
